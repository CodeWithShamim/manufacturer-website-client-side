...
const Dashboard = () => {
  return (
    <div className="h-fit bg-primary flex flex-col md:flex-row justify-center items-start">
      ...
      <div className="bg-black text-base-100 font-sans md:font-serif justify-center w-full md:w-60 list-none flex md:flex-col md:pb-96 gap-6 p-6 md:p-16 md:rounded-2xl md:mx-10 md:my-6 shadow-2xl">
        <li>
